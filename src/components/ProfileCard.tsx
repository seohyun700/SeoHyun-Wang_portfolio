      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between p-8 rounded-3xl bg-linear-to-br from-slate-900 to-indigo-950 text-white shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-8">
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="font-sans text-sm text-slate-300 mt-1 font-medium">
              ...
              <div className="space-y-4 pt-4 border-t border-white/10">
                ...
                <div className="flex items-center justify-between group">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col">
                      <span className="font-mono text-xs text-slate-400 leading-none">CONTACT</span>
                      <a href={`tel:${profileData.contact}`} className="font-sans text-sm font-semibold text-white mt-1 hover:text-cyan-400 transition-colors">
                        {profileData.contact}
                      </a>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between group">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col">
                      <span className="font-mono text-xs text-slate-400 leading-none">EMAIL</span>
                      <a href={`mailto:${profileData.email}`} className="font-sans text-sm font-semibold text-white mt-1 hover:text-cyan-400 transition-colors">
                        {profileData.email}
                      </a>
                    </div>
                  </div>
                ...
                <div className="flex items-start justify-between group">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex flex-col">
                      <span className="font-mono text-xs text-slate-400 leading-none">ADDRESS</span>
                      <span className="font-sans text-sm font-semibold text-slate-150 mt-1 leading-normal">
            ...
            {/* Bottom Card Footer */}
            <div className="mt-12 pt-4 border-t border-white/10 flex items-center justify-between text-xs font-mono text-slate-400">
          ...
          <div className="lg:col-span-7 flex flex-col justify-between p-8 rounded-3xl bg-slate-50 border border-slate-100 shadow-xs">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <span className="font-mono text-xs tracking-wider text-indigo-600 font-bold uppercase">
                  WHY SEOHYUN WANG?
                </span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                {profileStats.map((stat, idx) => (
                  <div key={idx} id={`profile-stat-box-${idx}`} className="p-4 bg-white rounded-xl border border-slate-100/80 shadow-xs space-y-1.5">
                    <span className="font-mono text-xs font-extrabold text-indigo-600 uppercase block">
                      {lang === "ko" ? stat.labelKo : stat.labelEn}
                    </span>
                    <span className="font-sans text-base font-bold text-slate-800 block leading-tight">
            ...
            <div className="mt-8 pt-6 border-t border-slate-200/60 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center space-x-2.5">
                ...
                <span className="font-sans text-sm text-slate-500 font-semibold">
              ...
              <div className="flex space-x-2 w-full sm:w-auto">
                <a
                  ...
                  className="flex-1 sm:flex-initial flex items-center justify-center space-x-1.5 px-4.5 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-sm font-bold transition-colors cursor-pointer"
                >
                ...
                <a
                  ...
                  id="profile-tel-cta"
                  className="flex-1 sm:flex-initial flex items-center justify-center space-x-1.5 px-4.5 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-sm font-bold transition-colors cursor-pointer"
                >
